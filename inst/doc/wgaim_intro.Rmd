...
```
## [1] "genoCxR.csv"  "genoRxK.csv"  "genoSxT.csv"  "phenoCxR.csv" "phenoRxK.csv" "phenoSxT.csv"
```
...
```
## Online License checked out Sun Aug 25 16:54:36 2024
## Model fitted using the gamma parameterization.
## ASReml 4.1.0 Sun Aug 25 16:54:36 2024
##           LogLik        Sigma2     DF     wall    cpu
##  1       128.285      0.202517    514 16:54:36    0.0
##  2       178.124      0.126231    514 16:54:36    0.0
##  3       211.555      0.086862    514 16:54:36    0.0
##  4       221.240      0.074148    514 16:54:36    0.0
##  5       222.515      0.071463    514 16:54:36    0.0
##  6       222.595      0.072380    514 16:54:36    0.0
##  7       222.606      0.072730    514 16:54:36    0.0
##  8       222.607      0.072856    514 16:54:36    0.0
```
...
<img src="variogram-1.png" alt="plot of chunk variogram" width="95%" />
<p class="caption">plot of chunk variogram</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="residuals-1.png" alt="plot of chunk residuals" width="95%" />
<p class="caption">plot of chunk residuals</p>
</div>
...
```
## Model fitted using the gamma parameterization.
## ASReml 4.1.0 Sun Aug 25 16:54:40 2024
##           LogLik        Sigma2     DF     wall    cpu
##  1       130.554      0.189858    513 16:54:40    0.0
##  2       182.276      0.113102    513 16:54:40    0.0
##  3       214.329      0.074662    513 16:54:40    0.0
##  4       223.385      0.060682    513 16:54:40    0.0
##  5       224.625      0.055965    513 16:54:40    0.0
##  6       224.654      0.055857    513 16:54:40    0.0
##  7       224.658      0.055957    513 16:54:40    0.0
##  8       224.658      0.056000    513 16:54:40    0.0
```
...
## 
##     No. chromosomes:    27 
##         Autosomes:      1A 1B 1D 2A 2B 2D1 2D2 3A 3B 3D 4A 4B1 4B2 4D 5A1 5A2 5B 5D1 5D2 6A 6B 
##                         6D 7A1 7A2 7B 7D1 7D2 
## 
##     Total markers:      500 
##     No. markers:        44 37 26 22 23 3 13 24 57 21 22 16 3 6 7 5 19 2 3 21 32 8 13 34 21 11 7 
...
```
## [1] "data"          "map"           "imputed.data"  "dist"          "theta"        
## [6] "interval.data"
```
...
```
## Model fitted using the gamma parameterization.
## ASReml 4.1.0 Sun Aug 25 16:54:41 2024
##           LogLik        Sigma2     DF     wall    cpu
##  1       213.621     0.0588101    516 16:54:41    0.0
##  2       213.817     0.0581169    516 16:54:41    0.0
##  3       213.964     0.0573401    516 16:54:41    0.0
##  4       214.009     0.0568377    516 16:54:41    0.0
##  5       214.012     0.0569412    516 16:54:41    0.0
##  6       214.012     0.0569805    516 16:54:41    0.0
```
...
```
## [1] "selection"  "method"     "type"       "diag"       "iterations" "breakout"   "qtl"       
## [8] "effects"    "veffects"
```
...
```
## [1] "oint"         "blups"        "lik"          "coef.list"    "vcoef.list"   "lik.mat"     
## [7] "state"        "genetic.term" "rel.scale"
```
...
```
##    Chromosome Left Marker dist(cM) Right Marker dist(cM)    Size   Prob % Var     LOD
## 1          1D    wPt-1799   128.29     wPt-1263   166.85 -0.0783 0.0015   2.7  1.9030
## 2          2A barc0220(C)    87.47      cfa2263    87.76  0.0629 0.0003   2.8  2.5099
## 3          2B    wPt-9644    25.24     wPt-5672    29.97 -0.0895 0.0000   5.3  3.6105
## 4          2B    wPt-3378   135.93     wPt-7360   136.11 -0.0790 0.0000   4.4  3.4345
## 5          3B    wPt-7984     6.65     barc0075        7  0.0648 0.0002   3.0  2.6647
## 6          3B     wmc0043    68.14  wPt-6973(C)    79.41  0.0859 0.0000   4.5  3.4353
## 7          3B    wPt-8021   244.67     gwm0114b   256.42 -0.1838 0.0000  19.8 14.4915
## 8          3D     cfd0064    53.42      cfd0034    61.54  0.1030 0.0000   6.7  5.6227
## 9         4B1    barc0114    48.32     wPt-0391    53.55 -0.0623 0.0009   2.7  2.1311
## 10         4D     wmc0457     6.56     barc0288     7.32  0.1012 0.0000   6.9  6.4987
```
...
<div class="figure" style="text-align: center">
<img src="out-1.png" alt="plot of chunk out" width="95%" />
<p class="caption">plot of chunk out</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="out-2.png" alt="plot of chunk out" width="95%" />
<p class="caption">plot of chunk out</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="link-1.png" alt="plot of chunk link" width="95%" />
<p class="caption">plot of chunk link</p>
</div>
